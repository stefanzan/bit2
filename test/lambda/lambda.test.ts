...
const exampleAST: LambdaAST.TermNode = {
  type:'seq',
  nodes: [
    { type: 'const', value: {type:'constant',value:'hello'} },
    { type: 'space', width: 1 },
    {
      type: 'lambda',
      variable: {type:'variable',name:'x'},
      body: { type: 'const', value:{type:'constant',value: 'world'}},
    ...
    },
    {
      ...
      body: { type: 'const', value:{type:'constant',value: 'test'}},
    ...
    },
    {
      ...
      body: { type: 'const', value:{type:'constant',value: 'example'}},
